    ...
    const confirmAction = () => {
        ...
        setShowSuccess({
            message: showWarning.action === 'approve' 
                ? `Department ${showWarning.id} approved successfully.` 
                : `Department ${showWarning.id} declined successfully.`
        });
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-sm mb-6 relative">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-gray-800">Department Budget Approvals</h2>
                <button 
                ...
                <table className="min-w-full bg-white">
                    <thead>
                        <tr className="bg-gray-100 text-gray-600 text-left">
                            <th className="py-3 px-4 font-bold">Department ID</th>
                            <th className="py-3 px-4 font-bold">Department Name</th>
                    ...
                    <tbody className="text-gray-600">
                        {departments.map((dept) => (
                            <tr key={dept.mId} className="border-b border-gray-200 hover:bg-gray-50">
                                <td className="py-3 px-4">{dept.mId}</td>
                                <td className="py-3 px-4">{dept.mName}</td>
                                <td className="py-3 px-4">₱{(dept.mBudget || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                                ...
                                <td className="py-3 px-4">
                                    <div className="flex space-x-2">
                                        <button 
                                            ...
                                            title="Approve"
                                            onClick={() => handleAction('approve', dept.mId)}
                                        >
                                            <CheckCircle size={20} />
                                        </button>
                                        <button 
                                            ...
                                            title="Decline"
                                            onClick={() => handleAction('decline', dept.mId)}
                                        >
                                            <XCircle size={20} />
                                        </button>
                                        <button 
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
                        ...
                        <p className="mb-6">
                            {showWarning.action === 'approve' 
                                ? `Are you sure you want to approve department ${showWarning.id}? This action cannot be undone.`
                                : `Are you sure you want to decline department ${showWarning.id}? This action cannot be undone.`
                            }
                        </p>
                ...
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-[999]">
                    <div className="bg-white p-6 rounded-lg shadow-lg max-w-4xl w-full">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="text-xl font-bold">Department Budget Details</h3>
                            <button 
                        ...
                        <div>
                            <h4 className="font-bold mb-2">Budget Allocation</h4>
